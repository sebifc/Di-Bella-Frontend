...
const filterSlice = createSlice({
  ...
  reducers: {
    ...
    FILTER_VALUEDS(state, action) {
      const { valueds, search } = action.payload;
      state.filteredValueds = valueds;
    },
  },
});
...
export const selectFilteredValueds = (state) => state.filter.filteredValueds;
